...
import { insightCategoryLabels, type InsightCategory } from '@/lib/insightsData'
...
export default function InsightsTabs({
  ...
  onTabChange: (category: InsightCategory) => void
}) {
  const tabs = Object.entries(insightCategoryLabels) as [InsightCategory, string][]
