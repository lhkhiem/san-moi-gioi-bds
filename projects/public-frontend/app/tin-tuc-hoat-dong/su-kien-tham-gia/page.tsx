...
function EventsPageContent() {
  ...
  const filteredArticles = useMemo(() => {
    return newsActivityArticles.filter(article => article.category === 'su-kien-tham-gia')
  }, [])
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-12">
        ...
        <div className="mb-8">
          ...
          >
            Các hội thảo, diễn đàn và sự kiện ngành mà INLANDV tham gia và đồng tổ chức
          </motion.p>
        </div>
